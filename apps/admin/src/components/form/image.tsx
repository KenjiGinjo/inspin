import type { ImageChooseProps } from '@inspin/interfaces'
import type { WrapperProps } from './base'
import { DEFAULT_IMAGE_LIMIT_SIZE, DEFAULT_IMAGE_LIMIT_TYPE } from '@inspin/constants'
import { IconImageFill } from '@inspin/svg'
...
function ImageChooser({
  ...
  const handleFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!limitType.includes(fileExtension || '')) {
      console.warn(`Unsupported file type, please select ${limitType.join(', ')} format image`)
      return
    }
